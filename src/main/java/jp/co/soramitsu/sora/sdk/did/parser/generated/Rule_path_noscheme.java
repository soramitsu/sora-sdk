...
final public class Rule_path_noscheme extends Rule {

  public Rule_path_noscheme(String spelling, ArrayList<Rule> rules) {
    super(spelling, rules);
  }

  public static Rule_path_noscheme parse(ParserContext context) {
    ...
    Rule rule = null;
    if (parsed) {
      rule = new Rule_path_noscheme(context.text.substring(a0.start, a0.end), a0.rules);
    } else {
      context.index = s0;
    }
