 ...
 * Produced : Sat Aug 25 23:27:45 EEST 2018</p>
 */
...
public class ParserException extends Exception {
  ...
  /**
   * Returns a substring of the parsed string that encompasses the point at which the parse failure
   * occurred. The substring will be up to 60 characters in length unless the point of failure
   * occurred within 30 characters of the start or end of the parsed string. {@link
   * #getSubstringIndex} returns an index to the character within this substring at which the parse
   * failure occurred. This substring may contain non-printable characters.
   *
  ...
  /**
   * Returns an index to the character within the substring returned by {@link #getSubstring} at
   * which the parse failure occurred.
   *
   * @return The index to the character within the substring returned {@link #getSubstring} at which
   * the parse failure occurred.
   */
  ...
  /**
   * Returns a message detailing the parse failure. The message detail the reason for the failure
   * and where the failure occurred.
   *
   * <br><br>For example ...<br><br><code>
   * rule "Minutes" failed<br> 15:75:47<br> &nbsp;&nbsp;&nbsp;^<br> rule stack:<br>
   * &nbsp;&nbsp;Clock<br> &nbsp;&nbsp;Minutes</code><br>
   *
