...
final public class Rule_segment_nz_nc extends Rule {

  public Rule_segment_nz_nc(String spelling, ArrayList<Rule> rules) {
    super(spelling, rules);
  }

  public static Rule_segment_nz_nc parse(ParserContext context) {
    ...
    Rule rule = null;
    if (parsed) {
      rule = new Rule_segment_nz_nc(context.text.substring(a0.start, a0.end), a0.rules);
    } else {
      context.index = s0;
    }
